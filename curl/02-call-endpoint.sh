#!/usr/bin/env bash
# 02-call-endpoint.sh — walk a full x402 handshake against a Hermes Plant
# paid endpoint. Shows the 402 challenge, prints the headers we're about to
# sign, signs via a tiny Node helper, and replays the request with the
...
# Pull the base64'd PAYMENT-REQUIRED challenge from the headers.
